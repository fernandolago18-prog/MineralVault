/**
 * Ejecuta la migración 007 (actualizar search_minerals) en Supabase
 */
...
async function runMigration() {
  console.log('=== EJECUTANDO MIGRACION 007 EN SUPABASE ===');
  
  const sqlFile = path.join(__dirname, '../supabase/migrations/007_update_search_function.sql');
