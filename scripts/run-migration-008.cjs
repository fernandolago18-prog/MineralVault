/**
 * Ejecuta la migración 008 (actualizar search_minerals para agrupar variedades) en Supabase
 */
...
async function runMigration() {
  console.log('=== EJECUTANDO MIGRACION 008 EN SUPABASE ===');
  
  const sqlFile = path.join(__dirname, '../supabase/migrations/008_only_parents_in_search.sql');
